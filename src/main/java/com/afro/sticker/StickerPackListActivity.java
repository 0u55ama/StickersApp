...
public class StickerPackListActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView.loadAd(adRequest);
            ...
            InterstitialAd.load(this,"ca-app-pub-9487995294051736/4019671910", adRequest,
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        Log.i(TAG, "onAdLoaded");
                        Toast.makeText(StickerPackListActivity.this, "onAdLoaded()", Toast.LENGTH_SHORT).show();
                    ...
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        ...
                        Toast.makeText(
                                StickerPackListActivity.this, "onAdFailedToLoad() with error: " + error, Toast.LENGTH_SHORT)
                                .show();
                    }
                });
    }
